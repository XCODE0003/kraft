...
<template>
    ...
    >
            ...
            <div class="input-label-block">
                ...
                <label for="name" class="input-wrapper">
                    <input
                        type="text"
                        id="name"
                        v-model="useContactModalStore().options.data.name"
            ...
            <div class="input-label-block">
                ...
                <label for="phone" class="input-wrapper">
                    <input
                        type="tel"
                        id="phone"
                        v-model="useContactModalStore().options.data.phone"
            ...
            <div class="input-label-block">
                ...
                <label for="time" class="input-wrapper">
                    <input
                        type="text"
                        id="time"
                        v-model="useContactModalStore().options.data.time"
            ...
            <div class="input-label-block">
                ...
                <label for="email" class="input-wrapper">
                    <input
                        type="email"
                        id="email"
                        v-model="useContactModalStore().options.data.email"
                        placeholder="you@email.com"
                        autocomplete="off"
                    />
                </label>
                <p
                    v-if="useContactModalStore().options.errors?.length > 0"
        ...
        <button
            ...
            @click="useContactModalStore().validate()"
        >
            Заказать звонок
        </button>
    </VueFinalModal>
