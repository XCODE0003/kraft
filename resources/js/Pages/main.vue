            ...
            <section class="flex container  items-center justify-center mx-auto flex-col gap-12">
                ...
                <div class="grid md:grid-cols-2 gap-3 w-full">
                    ...
                    <div class="advantages-card advantages-bg-2">
                        ...
                        <div class="advantages-card-text">
                            <p>Наша компания уже не первый год осуществляет оптовые поставки металлопроката по всей
                                России.</p>
                            <span>Благодаря наличию собственных складов мы выполняем поставки в самые кратчайшие
                                сроки.</span>
                        </div>
            ...
            <section class="container mx-auto max-md:flex-col flex items-start gap-28">
                <div class="flex md:max-w-[500px] flex-col gap-10">
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <button class="btn text-center btn-primary  justify-center py-4">
                            Заказать звонок
                        </button>
                    </div>
                </div>
